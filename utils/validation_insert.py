...
def insert_SQL(metric_insert, model_name, pid, dataset, file_name, scenario, adjusted, train_error, val_error, beta_val, lambda_val, windows_val):
    insert_sql = """INSERT into validated_parameters (model_name, pid, dataset, file_name, scenario, adjusted, TN, FP, FN, 
TP, precision, recall, fbeta, pr_auc, roc_auc, cks, train_error, validation_error, beta, lambda, windows) VALUES('{}', '{}', '{}', '{}', '{}', '{}', 
'{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')""".format(model_name, pid, dataset, file_name,scenario, adjusted, metric_insert.TN, metric_insert.FP, metric_insert.FN, metric_insert.TP, metric_insert.precision, metric_insert.recall, metric_insert.fbeta, metric_insert.pr_auc, metric_insert.roc_auc, metric_insert.cks, train_error, val_error, beta_val, lambda_val, windows_val)
...
@background
def ValidationMetrics(abnormal_segment, score, pos_label, std_dev_values, quantile_values, k_values, model_name, pid, dataset, file_name,train_error,val_error,beta_val,lambda_val,windows_val):
    for adjusted_points in (False,True):
        ...
        for std_dev in std_dev_values:
            ...
            insert_SQL(zscore_metrics, model_name, pid, dataset, file_name, "Z-Score: " + str(std_dev) + " std dev", adjusted_points,train_error,val_error,beta_val,lambda_val,windows_val)
        ...
        for quantile in quantile_values:
            ...
            insert_SQL(quantile_metrics, model_name, pid, dataset, file_name, "Percentile: " + str(quantile), adjusted_points,train_error,val_error,beta_val,lambda_val,windows_val)
        
        # @K
        for at_k in k_values:
            k_metrics = at_k_metrics(score, abnormal_segment, pos_label, at_k, adjusted_points)
            insert_SQL(k_metrics, model_name, pid, dataset, file_name, "@K: " + str(at_k) + "%", adjusted_points,train_error,val_error,beta_val,lambda_val,windows_val)

        # Best F1      
        bestf1_metrics = bestF1_metrics(score, abnormal_segment, pos_label, adjusted_points)
        insert_SQL(bestf1_metrics, model_name, pid, dataset, file_name, "Best F1", adjusted_points,train_error,val_error,beta_val,lambda_val,windows_val)
