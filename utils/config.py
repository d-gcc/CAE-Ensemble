...
class AEConfig(object):
    def __init__(self, dataset, x_dim, h_dim, ensemble_space, preprocessing, use_overlapping, rolling_size, epochs,
                 ...
                 save_output, save_figure, save_model, load_model, continue_training, dropout, use_spot, use_slope, slope,
                 use_last_point, save_config, load_config, server_run, robustness, adjusted_points, use_best_f1, pid):
...
class RAEConfig(object):
    def __init__(self, dataset, x_dim, h_dim, preprocessing, use_overlapping, rolling_size, epochs, milestone_epochs,
                 ...
                 load_config, server_run, robustness, adjusted_points, use_best_f1, pid):
...
class RAEEnsembleConfig(object):
    def __init__(self, dataset, x_dim, h_dim, preprocessing, use_overlapping, rolling_size, epochs, milestone_epochs,
                 lr, gamma, batch_size, weight_decay, early_stopping, loss_function, use_clip_norm, gradient_clip_norm,
                 rnn_layers, use_bidirection, force_teaching, force_teaching_threshold, display_epoch, save_output,
                 save_figure, save_model, load_model, continue_training, dropout, use_spot, use_last_point, save_config,
                 load_config, server_run, robustness, adjusted_points, use_best_f1, pid, use_slope, slope, ensemble_members,
                 drop_connections, max_memory_steps):
...
class RNNVAEConfig(object):
    def __init__(self, dataset, x_dim, h_dim, z_dim, preprocessing, use_overlapping, rolling_size, epochs, slope,
                 milestone_epochs, lr, gamma, batch_size, weight_decay, early_stopping, loss_function, use_clip_norm,
                 gradient_clip_norm, rnn_layers, lmbda, use_bidirection, force_teaching, force_teaching_threshold, use_slope,
...
class CAEConfig(object):
    def __init__(self, dataset, x_dim, h_dim, preprocessing, use_overlapping, rolling_size, ensemble, ensemble_members,
                 beta_transfer, diversity_factor, epochs, milestone_epochs, lr, gamma, batch_size, weight_decay, early_stopping, 
                 loss_function, display_epoch, save_output, save_figure, save_model, load_model, continue_training, dropout, 
                 use_spot, spot_q, spot_level, use_last_point, adjusted_points, save_config,load_config, server_run, 
                 robustness, pid, use_best_f1, use_slope, slope, validation, use_clip_norm, gradient_clip_norm):
        ...
        self.ensemble_members = ensemble_members
        self.beta_transfer = beta_transfer
...
class TFConfig(object):
    def __init__(self, dataset, x_dim, h_dim, f_dim, num_layers, num_heads, preprocessing, use_overlapping,
                 rolling_size, epochs, milestone_epochs, lr, gamma, batch_size, weight_decay, early_stopping,
                 loss_function, display_epoch, save_output, save_figure, save_model, load_model, continue_training,
...
class OCConfig(object):
    def __init__(self, dataset, model_type, x_dim, embedding_dim, w_dim, V_dim, cell_type, preprocessing, encoding_type,
                 epochs, ae_epochs, milestone_epochs, ae_milestone_epochs, lr, ae_lr, gamma, ae_gamma, batch_size,
...
class VRAEConfig(object):
    def __init__(self, dataset, x_dim, h_dim, z_dim, preprocessing, use_overlapping, rolling_size, epochs,
                 ...
                 save_config, load_config, server_run, robustness, adjusted_points, use_best_f1, pid, use_slope, slope):
...
class DAGMMConfig(object):
    def __init__(self, dataset, x_dim, h_dim, z_dim, n_gmm, preprocessing, use_overlapping, rolling_size, epochs,
                 ...
                 server_run, robustness, adjusted_points, use_best_f1, pid):
...
class BEATGANConfig(object):
    def __init__(self, dataset, model_type, x_dim, h_dim, z_dim, preprocessing, use_overlapping, rolling_size, epochs,
                 ...
                 adjusted_points,use_best_f1,pid):
...
class ISFConfig(object):
    def __init__(self, dataset, x_dim, n_estimators, max_samples, contamination, max_features, bootstrap, save_output,
                 save_figure, save_model, load_model, use_spot, save_config, load_config, server_run, preprocessing, 
                 robustness, adjusted_points, use_best_f1, pid, use_slope, slope, use_overlapping, rolling_size, 
                 use_last_point):
...
class LOFConfig(object):
    def __init__(self, dataset, x_dim, n_neighbors, algorithm, leaf_size, metric, p, contamination, save_output,
                 save_figure, save_model, load_model, use_spot, save_config, load_config, server_run, robustness, 
                 adjusted_points, use_best_f1, pid, use_slope, slope, preprocessing, use_overlapping, rolling_size, 
                 use_last_point):
...
class OCSVMConfig(object):
    def __init__(self, dataset, x_dim, kernel, degree, gamma, coef0, tol, nu, save_output, save_figure, use_overlapping,
                 save_model, load_model, use_spot, save_config, load_config, server_run, robustness, preprocessing,
                 adjusted_points, use_best_f1, pid, use_slope, slope, rolling_size, use_last_point):
...
class ARMAConfig(object):
    def __init__(self, dataset, x_dim, train_window, AR, MA, display, save_output, save_figure, use_spot,
                 save_config, load_config, server_run, robustness, I, S_P, S_D, S_Q, S_s, pid):
...
class MASConfig(object):
    def __init__(self, dataset, x_dim, model_type, window, alpha, display, save_output, save_figure, use_spot,
                 save_config, load_config, server_run, robustness, adjusted_points, pid):
...
class STLConfig(object):
    def __init__(self, dataset, x_dim, period, robust, display, save_output, save_figure, use_spot,
                 save_config, load_config, server_run, robustness, pid):
...
class MSCREDConfig(object):
    def __init__(self, dataset, x_dim, h_dim, step_max, epochs, milestone_epochs, lr, gamma, batch_size, weight_decay,
                 ...
                 dropout, use_spot, save_config, load_config, server_run, robustness, pid,adjusted_points,use_best_f1):
